...
const RestCard = ({obj,history}) => {
    const {id,imgLink,name,cuisines,avgRating,duration,costForTwoString,shortDiscount,locality,area,menuCategory,quickView} = obj;
    return(
        <>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="menu-img">
                                {
                                    quickView.map(
                                        (el) => <div className="img-holder">
                                                    <img src={el.imgLink} width="112" height="71"/>
                                                    <div>{el.name}</div>
                                                </div>
                                    )
                                }
