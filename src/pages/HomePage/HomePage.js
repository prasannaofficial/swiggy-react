    ...
    login = () => {
        ...
        if (!email) {
            ...
            if (apos < 1 || dotpos - apos < 2) {
                this.setState({
                    redMessage: "Incorrect Email ID or Password!!",
                });
                return;
            }
        }
