...
class MyOrdersPage extends Component {
    ...
    fetchMyOrders = async () => {
        ...
        const response = await fetch(
            `${backendLink}/api/ordershistory?q=${this.state.queryString}&limit=${this.state.limit}&offset=${this.state.offset}&sort=${this.state.sortString}`,
            {
                method: "GET",
                headers: myHeaders,
            }
                            ...
                            <div className="head-section">
                                ...
                                <div>
                                    <ul>
                                        <a
                                            href="#"
                                            onClick={this.sortNewestHandler}
                                        >
                                            <li>Newest</li>
                                        </a>
                                        <a
                                            href="#"
                                            onClick={this.sortOldestHandler}
                                        >
                                            <li>Oldest</li>
                                        </a>
                                        <a
                                            href="#"
                                            onClick={this.sortAsceHandler}
                                        >
                                            <li>Sort A-Z</li>
                                        </a>
                                        <a
