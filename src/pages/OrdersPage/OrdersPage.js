...
const mapDispatchToProps = (dispath) => {
    return {
        setMenu: (menu) => dispath(setMenu(menu)),
    };
};
...
class OrdersPage extends Component {
    ...
    fetchRestaurantDetails = async (restId) => {
        ...
        const response = await fetch(
            backendLink + "/api/restaurant/" + restId,
            {
                method: "GET",
                headers: myHeaders,
            }
                            ...
                            <div className="hotel-intro">
                                ...
                                <div className="middle-section">
                                    ...
                                    <div className="address">
                                        {this.state.locality}, {this.state.area}
                                    </div>
                                    <div className="info">
                                        <div className="col1">
                                            <div
                                ...
                                <div>
                                    ...
                                    <div className="right-section">
                                        ...
                                        <div className="offers-li">
                                            ...
                                            <div>
                                                20% off up to ₹300 on orders
                                                above ₹600 | Use code PARTY
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="loader-explore-pane-container">
                            <div className="loader-explore-pane">
                                ...
                                <div className="loader-text">
                                    Looking for great food items in this
                                    restaurant ...
                                </div>
                            </div>
                        </div>
